...
import { usePagination } from '@/shared/hooks/customs/usePagination';
import { useSearchbar } from '@/shared/hooks/customs/useSearchbar';
import Paginations01 from '@/shared/ui/pagination/01/Paginations01.index';
...
import BoardBestCard from '@/features/boards/ui/best/BoardBestCard.index';
import { useQueryFetchBoards } from '@/shared/hooks/queries/useQueryFetchBoards';
import { useQueryFetchBoardsCount } from '@/shared/hooks/queries/useQueryFetchBoardsCount';
import { useQueryFetchBoardsOfTheBest } from '@/shared/hooks/queries/useQueryFetchBoardsOfTheBest';
import { BLB } from './body/BoardListBody.css';
