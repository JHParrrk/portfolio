    ...
    images: yup
      ...
      .of(
        yup
          .string()
          .when([], {
            // isEdit이 true일 경우, URL 유효성 검사 없이 null을 허용합니다.
            is: () => isEdit,
            then: (schema) => schema.nullable(),
            // isEdit이 false일 경우, URL 형식이 유효해야 합니다.
            otherwise: (schema) =>
              schema.url("유효한 URL을 입력해주세요").nullable(),
          })
          .default("")
      )
...
export type IFormData = yup.InferType<ReturnType<typeof getBoardSchema>>;
